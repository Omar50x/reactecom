        ...
        <div className="container-fluid px-4">
            ...
            <form onSubmit={submitCategory} id="CATEGORY_FORM">
                ...
                <div className="tab-content" id="myTabContent">
                    <div className="tab-pane p-3 card-body border fade show active" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab" tabindex="0">
                    ...
                    <div className="tab-pane p-3 card-body border fade" id="seo-tags" role="tabpanel" aria-labelledby="seo-tags-tab" tabindex="0">
                        <div className="form-group mb-3">
